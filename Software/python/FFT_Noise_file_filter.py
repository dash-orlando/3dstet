...
filename = r"C:\Users\pd3dlab\Documents\Gits\PD3D\3dstet\Software\Audio Files\roomtone.wav"
signal, FFT, FFT_side, freqs, freqs_side, t, Mag_db = Run_FFT( filename )
...
inverted_fft = np.fft.irfft(y, n).astype(np.int16)
#inverted_fft = np.fft.irfft(np.fft.rfft(OG_Signal))
...
wavfile.write(r"C:\Users\pd3dlab\Documents\Gits\PD3D\3dstet\Software\Audio Files\reformated_fft.wav", 44100, inverted_fft)
